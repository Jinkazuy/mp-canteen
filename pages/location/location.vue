<template>
	<div class="location">
		<div class="top-bar-wrapper" v-if="locationFlag">
		...
		<div class="current-location-wrapper" v-if="locationFlag">
		...
		<div class="nearby-addr-wrapper" v-if="locationFlag">
		...
		<div class="location-err" v-if="!locationFlag">
		...
		<div class="testteset">
			西经：{{locationInfo.longitude}}
			南纬：{{locationInfo.latitude}}
		</div>
	</div>
</template>
